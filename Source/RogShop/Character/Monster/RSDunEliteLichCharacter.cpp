...
#include "RSDunEliteLichCharacter.h"
#include "RogShop/UtilDefine.h"
#include "RogShop/RSMonsterAttackTraceDefine.h"

void ARSDunEliteLichCharacter::PlayBaseAttackAnim()
{
...
void ARSDunEliteLichCharacter::PlayHitReactAnim()
{
	PlayAnimMontage(HitReactMontage);
	UE_LOG(LogTemp, Warning, TEXT("Boss SpiderQueen HitReact Success!!"));
}

void ARSDunEliteLichCharacter::PlayDeathAnim()
{
